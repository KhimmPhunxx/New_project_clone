...
export default function ServicePageAPI() {
    const ServiceAPI = [
        ...
        },
        {
            ...
            icon: '🎨',
            title: 'UX / UI',
            description: 'Bringing your online vision to life with Khodedevs expertise. We build dynamic and responsive websites tailored to your needs.',
        },
            ...
            <div className='grid md:grid-cols-3 max-w-5xl mx-auto gap-4'>
                {
                    ServiceAPI.map((service, index) => {
                        return (
                            <div key={index} className='mx-auto w-[90%] py-10 p-4 bg-white dark:bg-black shadow-md shadow-gray-300 border border-gray-100 rounded-md dark:shadow-lg dark:shadow-[#615EAB] dark:border dark:border-gray-700' data-aos="fade-up">
